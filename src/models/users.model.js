...
usersSchema.methods.startSession = async function () {
...
usersSchema.methods.checkIsManager = async function () {
    // Generate an auth token for the user	
    const user = this
    let isManager = false
...
usersSchema.methods.checkIsOnboarding = async function () {
    // Generate an auth token for the user
    const user = this
...
usersSchema.methods.checkIsFinanceMgr = async function () {
    // Generate an auth token for the user
    const user = this
...
usersSchema.methods.checkIsHRMgr = async function () {
    // Generate an auth token for the user
    const user = this
    let isHRMgr = false
...
usersSchema.methods.checkIsSalAcc = async function () {
    // Generate an auth token for the user
    const user = this
    let isSalAcc = false
...
usersSchema.methods.getAccessPages = async function () {
    // Generate an auth token for the user
    const user = this
    let isSalAcc = false
...
usersSchema.statics.findByEmail = async (email) => {
...
usersSchema.methods.checkUserFirstLogin = async function () {
    const user = this
...
usersSchema.methods.generateResetTokenMSO = async function () {
    const user = this
...
// find by email
usersSchema.statics.findByEmailAddress = async (email) => {
    // Search for a user by email.
    const user = await Users.findOne({ email: email, user_status: { $ne: 'Inactive' } });
    if (!user) {
        throw new Error({ error: 'No User Found' })
